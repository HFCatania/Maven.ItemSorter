...
public class SortByPriceTest {
    ...
    public void test1() {
        // given
        Item item3 = new Item(0L, "Apple", 7.0);
        Item item2 = new Item(1L, "Banana", 4.0);
    ...
    public void test3() {
        // given
        Item item3 = new Item(0L, "Leon", 24.0);
        Item item2 = new Item(1L, "Nhu", 51.0);
        Item item1 = new Item(2L, "Wilhem", 271.0);
        Item[] itemsToSort = {item2, item1, item3};
        Item[] expected = {item3, item2, item1};
        ItemSorter itemSorter = new ItemSorter(itemsToSort);
        Comparator<Item> comparator = (Comparator<Item>) new NameComparator();
